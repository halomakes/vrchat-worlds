Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi World/e570c2942a91b214bac118b403cacaba"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float2 st = frac(poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0,0,0).xy * _Time.x) * (1405.5 /*_GlitterFrequency*/);
				...
				switch((0.0 /*_GlitterMode*/))
				{
					...
					finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.759 /*_GlitterBias*/)), poiCam.viewDir)), (300.0 /*_GlitterContrast*/)), 0);
				...
				float glitterMask = 1;
				#endif
				glitterMask *= lerp(1, poiLight.rampedLightMap, (0.331 /*_GlitterHideInShadow*/));
				...
				{
					poiFragData.baseColor = lerp(poiFragData.baseColor, finalGlitter * glitterColor * (3.1 /*_GlitterBrightness*/), finalGlitter * glitterTexture.a * glitterMask);
					poiFragData.emission += finalGlitter * glitterColor * max(0, ((3.1 /*_GlitterBrightness*/) - 1) * glitterTexture.a) * glitterMask;
				}
				else
				{
					poiFragData.emission += finalGlitter * glitterColor * (3.1 /*_GlitterBrightness*/) * glitterTexture.a * glitterMask;
				}
			}
			#endif
			#ifdef POI_SUBSURFACESCATTERING
			void applySubsurfaceScattering(in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh)
			{
				...
				float SSS = 1;
				#endif
				float3 vLTLight = poiLight.direction + poiMesh.normals[0] * (0.934 /*_SSSDistortion*/);
				float flTDot = pow(saturate(dot(poiCam.viewDir, -vLTLight)), (12.7 /*_SSSSpread*/)) * (0.412 /*_SSSStrength*/);
				#ifdef UNITY_PASS_FORWARDBASE
				...
				#endif
				poiLight.finalLightAdd += fLT * poiLight.directColor * float4(0.02989506,0.04216648,0.07417664,1) * poiLight.attenuation;
			}
			#endif
			...
			{
				float smoothness = (0.868 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (1.0 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.12 /*_MochieMetallicMultiplier*/);
				...
				#endif
				reflectionMask *= (0.453 /*_MochieReflectionStrength*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float4 mainTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_MainTex, _MainTex, poiUV(mainUV, float4(16,16,0,0)), float4(0,0,0,0), (1.0 /*_MainTexStochastic*/));
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(16,16,0,0)), float4(0,0,0,0), (1.0 /*_BumpMapStochastic*/)), (0.94 /*_BumpScale*/));
				#else
